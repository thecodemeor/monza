// ============================================================================
// Monza Checkbox Group Styles
// ============================================================================
// Defines layout and interaction styles for grouping multiple
// Checkbox components within the Monza Design System. The group
...
import { MonCheckbox } from './checkbox';
import { Subscription } from 'rxjs';

@Component({
    selector: 'mon-checkbox-group',
    templateUrl: './checkbox-group.html',
    styleUrls: ['./checkbox-group.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [{
        provide: NG_VALUE_ACCESSOR,
        useExisting: forwardRef(() => MonCheckboxGroup),
        multi: true
    }]
})
export class MonCheckboxGroup implements AfterContentInit, ControlValueAccessor, OnDestroy {
    ...
    @ContentChildren(MonCheckbox, { descendants: true }) boxes!: QueryList<MonCheckbox>;
