// ============================================================================
// Monza Currency Styles
// ============================================================================
// Defines display and formatting styles for the Currency component in the
// Monza Design System. Used to present numeric values with clear visual
...
@Component({
    selector: 'mon-currency',
    templateUrl: './currency.html',
    styleUrls: ['./currency.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MonCurrency implements AfterContentInit {
    @Input() value?: number;
    @Input() currency: string = 'RM';
    @Input() size?: number = 0;
