// ============================================================================
// Monza Pagination Styles
// ============================================================================
// Defines base and variant styles for the Pagination component in the
// Monza Design System. Pagination controls let users navigate large
...
import { MonIcon } from '../mon-icon/icon'; // adjust path if needed

export interface MonPageChangeEvent {
    pageIndex: number;
    pageSize: number;
}
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, FormsModule, MonIcon],
    templateUrl: './pagination.html',
    styleUrls: ['./pagination.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class MonPagination implements OnChanges {
  ...
  /** Zero-based page index */
    ...
    /** Composite change event */
    @Output() pageChange = new EventEmitter<MonPageChangeEvent>();
