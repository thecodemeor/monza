...
import { MonAccordionItem } from './accordion-item';

@Component({
    selector: 'mon-accordion',
    standalone: true,
...
export class MonAccordion implements AfterContentInit {
    @Input() multi = false;

    @ContentChildren(MonAccordionItem, { descendants: true })
    items!: QueryList<MonAccordionItem>;
    ...
    _notifyItemToggled(source: MonAccordionItem): void {
